...
{
    yaml_schema_cpp::YamlServer yaml_server({SCHEMA_DIR}, ROOT_DIR + "/test/yaml/duplicated_input.yaml", true);
...
{
    EXPECT_THROW(yaml_schema_cpp::YamlServer({SCHEMA_DIR}, ROOT_DIR + "/test/yaml/duplicated_input.yaml", false),
                 std::runtime_error);
}
